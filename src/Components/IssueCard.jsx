...
function IssueCard(number,assignees,title,html_url,url,created_at) {
    const { user } = useAuth();
        ...
        <div className="flex justify-between">
          ...
          <h3 className="flex">
            ...
            <p
              ...
              style={{
                color:
                  Object.keys(assignees).length === 0 ? "lime" : "yellow",
              }}
            >
