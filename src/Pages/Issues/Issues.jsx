...
const LoadingSkeleton = () => {
  // You can customize this loading skeleton as per your design
  return (
    <div className="bg-gray-900 rounded-xl h-56 p-4 animate-pulse">
      ...
      <div className="bg-inherit text-white">
        <div className="flex justify-center mt-4 m-6 text-black">
          <input
            ...
            className="px-4 w-3/4 py-2 border-2 border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-300 bg-slate-200"
          />
        </div>
          ...
          issues.map((issue) => (
            <div key={issue.id} className="bg-gray-900 rounded-xl h-56 p-4">
              ...
              <div className="flex justify-evenly mt-3 items-center">
                <p className="rounded-xl mb-2 w-1/2">
